...
#### From Jenkins home page select "New Item"
   ...
   - *Source Code Management:*
      - Repository: `https://github.com/lalitsharma17/hello-world.git`
  ...
  - *Post-build Actions*  
    - Send build artifacts over SSH  
      - *SSH Publishers*  
	       - Exec command: 
                ```sh 
                ansible-playbook -i /opt/docker/hosts /opt/docker/kubernetes-test-deployment.yml;
                ansible-playbook -i /opt/docker/hosts /opt/docker/kubernetes-test-service.yml;
                ```
Save and run the job.
